export default function Privacy() {
  return (
    <>
      <div className="bg-nedel-blue py-5 rounded-b-3xl mb-5">
        <h3 className="text-center text-white">Política de Privacidade</h3>
      </div>
      <p>
        A sua privacidade é importante para nós. É política da Nedel Sistemas
        LTDA respeitar a sua privacidade em relação a qualquer informação sua
        que possamos coletar no site{" "}
        <a
          href="http://sistemas.nedel.inf.br"
          target="_blank"
      ...
      <p>
        ...
        informação que o Nedel Sistemas LTDA oferece no site e com caráter
      ...
      <ol className="list-decimal pl-10">
        ...
        <li>
          ...
          (softwares) do Nedel Sistemas LTDA, de seus fornecedores ou terceiros,
      ...
      <p>Esta política é efetiva a partir de 6 April 2026 11:21</p>
    </>
  );
}
